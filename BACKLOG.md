...
- [#0107 App-managed signature files with a management overlay](docs/tickets/0107-app-managed-signatures.md) -- feature _(extends #0106; moves signatures out of config.toml)_
