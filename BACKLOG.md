...
- [#0013 Homebrew tap](docs/tickets/0013-homebrew-tap.md) -- chore, **blocked**: needs the `homebrew-email` tap repo + `HOMEBREW_TAP_TOKEN` secret ([manual steps](docs/release-process.md#homebrew-tap)); repo-side work done
