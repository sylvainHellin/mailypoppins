...
The token is cached at `~/.email-cli/tokens/<account>.json` and will be automatically refreshed when it expires (access tokens last ~1 hour, refresh tokens ~90 days).
